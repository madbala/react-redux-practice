...
export const Login = function(props) {
  ...
  const doForgotPassword = ()=>{
    axios.post("/forgotpassword").then(()=>{navigate(val.data.route); return;}).catch(function () { 
      alert(val.data.message);
    });
    ...
    return (
      ...
      > 
        {props => {
          ...
          <p style={{textDecoration: "underline",marginBottom:"0px",cursor:"pointer"}} onClick={doForgotPassword}>
                    Forgot Password
          </p>
                </div>
              </div>
